...
- **Slot 注入**：`conversation.session.header.utilities`（⭐ 按钮）
...
- 🎯 **⭐ One-click Marker**: Button in conversation header to mark main-line, visually intuitive
...
- 🧪 **Test Coverage**: 31 unit tests, 100% passed
